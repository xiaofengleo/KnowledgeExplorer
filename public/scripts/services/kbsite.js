...
query="PREFIX rdfs:   <http://www.w3.org/2000/01/rdf-schema#> prefix ae: <http://actrisexample.eu/ns/> CONSTRUCT{ ?subject ?property ?object . ?subject     rdfs:label 'filter_absorption_photometer' . ?object rdfs:label 'aerosol_absorption_coefficient' . ?syn ae:hasvalue 'aerosol_absorption_coefficient' .} WHERE { VALUES ?property {ae:measures} ?subject ae:measures ?object . ?syn ae:hasvalue 'aerosol_absorption_coefficient' .}" ;

//query="prefix dcterms: <http://purl.org/dc/terms/> prefix envri: <http://envri.eu/ns/> prefix foaf: <http://xmlns.com/foaf/0.1/> prefix rdf: <http://www.w3.org/1999/02/22-rdf-syntax-ns#> prefix rdfs: <http://www.w3.org/2000/01/rdf-schema#> prefix skos: <http://www.w3.org/2004/02/skos/core#> prefix xml: <http://www.w3.org/XML/1998/namespace> prefix xsd: <http://www.w3.org/2001/XMLSchema#> PREFIX rm: <http://www.oil-e.net/ontology/envri-rm.owl#> PREFIX dc: <http://purl.org/dc/elements/1.1/> prefix context: <http://147.213.76.116:8080/marmotta/context/> prefix eosc: <http://eosc.eu/> prefix prov: <http://www.w3.org/ns/prov#> prefix orcid: <https://orcid.org/> prefix np: <http://www.nanopub.org/nschema#> prefix fair: <https://w3id.org/fair/principles/terms/> prefix icc: <https://w3id.org/fair/icc/terms/> prefix pav: <http://purl.org/pav/> prefix dct: <http://purl.org/dc/terms/> prefix sio: <http://semanticscience.org/resource/> prefix npx: <http://purl.org/nanopub/x/> prefix owl: <http://www.w3.org/2002/07/owl#> prefix schema: <http://schema.org/> prefix envriri: <http://envri.eu/RI/> PREFIX dcterms: <http://purl.org/dc/terms/> PREFIX envri: <http://envri.eu/ns/> PREFIX rm: <http://www.oil-e.net/ontology/envri-rm.owl#> PREFIX fairterms: <https://w3id.org/fair/principles/terms/> CONSTRUCT {?subject ?property ?object} WHERE { envri:usesSoftware ?property  ?object . BIND ( envri:usesSoftware AS ?subject ).}";

endpoint="http://banach.vlan400.uvalight.net:3030/actris/query";
//endpoint="http://banach.vlan400.uvalight.net/sparql?";
//sparqlSelectQuery(query, endpoint, 'rEnvri');

sparqlConstructQuery(query, endpoint, 'gEnvriG', 'rEnvriG1');
